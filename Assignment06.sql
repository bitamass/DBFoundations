...
Inventories.InventoryDate, [EmployeeName]= Employees.EmployeeFirstName + ' ' + Employees.EmployeeLastName 
From Inventories
Join Employees
...
as
Select TOP 10000 
Categories.CategoryName, Products.ProductName, Inventories.InventoryDate, Inventories.[Count], EmployeeName = Employees.EmployeeFirstName + ' ' + Employees.EmployeeLastName
From Categories
Join Products
On Categories.CategoryID =Products.CategoryID
Join Inventories
